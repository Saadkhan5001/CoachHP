...
export function Reviews() {
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto mt-14 max-w-content-classic px-5 lg:px-6">
            ...
            {REVIEWS.map((r, i) => (
              ...
              >
                <article className="flex h-full min-h-[320px] flex-col rounded-[26px] bg-dark-card2 p-6 sm:min-h-[380px] sm:p-8">
                  <Quote className="h-9 w-9 rotate-180 fill-[#c01d18] text-[#c01d18]" />
        ...
        {snaps.map((_, i) => (
          <button
            ...
            className={`h-2 rounded-full transition-all ${
              selected === i ? "w-6 bg-[#c01d18]" : "w-2 bg-white/25"
            }`}
          />
        ))}
      </div>
