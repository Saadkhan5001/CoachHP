      ...
      <div className="mx-auto mt-14 grid max-w-content gap-3 px-5 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1fr)_minmax(0,1.5fr)] lg:px-6">
        ...
        <Reveal className="flex flex-col gap-3 lg:h-[620px]">
          ...
          <div className="relative flex-1 overflow-hidden rounded-3xl">
            <div
              ...
              style={{ backgroundImage: "url(/images/curtis/gym-location.jpg)" }}
            />
            ...
            <div className="relative flex h-full flex-col justify-between p-5">
              ...
              <div className="text-white">
                <h3 className="text-[1.3rem] font-semibold leading-tight">Framer Gym</h3>
                <p className="text-[0.85rem] text-white/70">Amsterdam</p>
              </div>
            </div>
          </div>
        </Reveal>
        ...
        <Reveal delay={0.16} className="lg:h-[620px]">
          <div className="flex h-full flex-col justify-between rounded-3xl bg-white p-8 sm:p-10">
            <div>
              <h3 className="text-[2rem] font-semibold tracking-tight">Curtis Johnson</h3>
              <p className="mt-5 text-[0.98rem] leading-relaxed text-black/60">
                With over six years in the fitness industry, I specialise in
                building real strength, improving conditioning, and developing
                long-term physical capacity. My coaching is rooted in structured
                programming, technical precision, and measurable progression, with
                a clear focus on results that last rather than quick fixes.
              </p>
              <p className="mt-4 text-[0.98rem] leading-relaxed text-black/60">
                I prioritise strong fundamentals, progressive overload, and
                purposeful conditioning to build resilient, capable bodies. I hold
                a high standard for the work I deliver, ensuring every programme is
                intentional, progressive, and built around continuous improvement.
              </p>
            </div>
