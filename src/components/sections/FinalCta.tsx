  ...
  return (
    ...
    >
      <div
        ...
        style={{ backgroundImage: "url(/images/curtis/cta-bg.jpg)" }}
        aria-hidden="true"
      />
      ...
      <footer className="relative border-t border-white/10 px-6 py-6 sm:px-10">
        <div className="mx-auto flex max-w-hero flex-col items-center justify-between gap-5 text-center sm:flex-row sm:text-left">
          ...
          <div className="flex items-center gap-2 text-[0.85rem] text-white/60">
            ...
            <span className="flex h-6 w-6 items-center justify-center rounded-full bg-accent text-[0.7rem] font-bold text-black">
              J
            </span>
            <span className="font-medium text-white/80">Jak</span>
          </div>
        </div>
      </footer>
    </section>
