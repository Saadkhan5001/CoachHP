  ...
  return (
    ...
    >
      <div
        ...
        style={{ backgroundImage: "url(/images/curtis/pricing-bg.jpg)" }}
        aria-hidden="true"
      />
              ...
              <Reveal key={plan.name} delay={featured ? 0.08 : 0}>
                <div
                  className={`relative rounded-[26px] p-2.5 ${
                    featured
                      ? "bg-black lg:-translate-y-4"
                      : "bg-white"
                  }`}
                >
                  {featured && (
                    <span className="absolute -top-3 right-5 z-10 flex items-center gap-1.5 rounded-full bg-accent px-3 py-1.5 text-[0.78rem] font-semibold text-black">
