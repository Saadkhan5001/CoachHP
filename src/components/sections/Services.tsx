    ...
    <div id="services" className="mx-auto max-w-content px-5 pt-20 sm:pt-28 lg:px-6">
      ...
      <div className="mt-14 grid gap-3 md:grid-cols-2">
        ...
        <Reveal className="md:row-span-2">
          <article className="relative flex min-h-[420px] flex-col justify-end overflow-hidden rounded-[26px] md:min-h-[540px]">
            <div
        ...
        <Reveal delay={0.06}>
          <article className="relative flex min-h-[220px] items-center overflow-hidden rounded-[26px] bg-dark-card2">
            <div
              className="absolute inset-y-0 right-0 w-[52%] bg-cover bg-center"
              style={{ backgroundImage: "url(/images/curtis/svc-conditioning.jpg)" }}
            />
            <div className="absolute inset-0 bg-gradient-to-r from-dark-card2 via-dark-card2/85 to-transparent" />
            <div className="relative max-w-[58%] p-7 sm:p-8">
        ...
        <Reveal delay={0.12}>
          <div className="grid grid-cols-2 gap-3">
            <article className="flex min-h-[250px] flex-col items-center justify-center rounded-[26px] bg-dark-card2 p-6 text-center">
            ...
            <article className="relative flex min-h-[250px] flex-col items-center justify-center overflow-hidden rounded-[26px] p-6 text-center">
              <div
